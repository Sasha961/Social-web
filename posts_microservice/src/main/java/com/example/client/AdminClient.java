...
import com.example.client.config.FeignSupportConfig;
...
public interface AdminClient {
    ...
    StorageDto getLinkForUploadImage(@RequestHeader("Authorization")@NonNull String bearerToken, @RequestBody MultipartFile file);
}
